...
namespace MVCRazorCRUD.Models
{
    public class Aluno : UsuarioBase , IAluno 
    {
        ...
        public void AtualizarAluno(Aluno aluno)
        {
            ...
            connection.Open();
            var query = "update Alunos set alunoNome = @nome, alunoEmail = @email, alunoEndereco = @endereco, alunoTelefone = @telefone, alunoEscolaridade = @escolaridade where alunoId = @id";
